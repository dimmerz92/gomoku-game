...
})({"5wrgQ":[function(require,module,exports) {
"use strict";
...
var _handler = require("./Classes/Handler");
var _handlerDefault = parcelHelpers.interopDefault(_handler);
new (0, _handlerDefault.default)();

},{"./Classes/Handler":"aOTK3","@parcel/transformer-js/src/esmodule-helpers.js":"c2uBj"}],"aOTK3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gamecontrols = require("../Helpers/gamecontrols");
...
class Handler {
    constructor(){
        (0, _render.Render).append((0, _gamecontrolsDefault.default)(), "main");
        this.player = PLAYER.A;
        this.newgame = document.getElementById("newgame");
        this.newgame?.addEventListener("click", ()=>{
            this.getGridSize();
            this.gameboard = new (0, _gameboardDefault.default)(this, this.size);
            (0, _render.Render).removeNode("gameboard");
            (0, _render.Render).removeNode("endgame");
            (0, _render.Render).append(this.gameboard.getGameboard, "main");
            const h2 = document.createElement("h2");
            h2.id = `${this.player.toLowerCase()}Turn`;
            h2.textContent = `${this.player}'S TURN`;
            (0, _render.Render).append(h2, this.player.toLowerCase());
        });
    }
    ...
    getGridSize() {
        ...
        if (sizes && !Array.from(sizes).some((c)=>c.classList.contains("selected"))) return;
    ...
    nextTurn(cellId) {
        ...
        (0, _render.Render).removeNode(`${this.player.toLowerCase()}Turn`);
        const result = this.gameStatus(cellId, row, col);
        if (result) return this.endGame(result);
        if (this.player === PLAYER.A) this.player = PLAYER.B;
        else this.player = PLAYER.A;
        const h2 = document.createElement("h2");
        h2.id = `${this.player.toLowerCase()}Turn`;
        h2.textContent = `${this.player}'S TURN`;
        (0, _render.Render).append(h2, this.player.toLowerCase());
    ...
    gameStatus(cellId, row, col) {
        ...
        if (rightDiag === 5 || leftDiag === 5) return RESULT.WIN;
        else if (this.linearCheck(row) || this.linearCheck(-1, col)) return RESULT.WIN;
        else if (this.gamemap.flat().every((i)=>i !== undefined)) return RESULT.DRAW;
        else return false;
    }
    // recursively sums the number of a specific pebble in a diagonal direction
    diagonalCheck(cellId, direction) {
    ...
    linearCheck(row, col = -1) {
        const arr = col < 0 ? this.gamemap[row] : this.gamemap.map((i)=>i[col]);
        if (this.size === 5) return arr.every((i)=>i === this.player);
        for(let i1 = 0; i1 < this.size - 5; i1++){
            if (arr.slice(i1, i1 + 5).every((i)=>i === this.player)) return true;
        }
        return false;
    }
    // ends the game
...
},{"../Helpers/gamecontrols":"hmM3c","./Gameboard":"lrcID","./Render":"eksWm","@parcel/transformer-js/src/esmodule-helpers.js":"c2uBj"}],"hmM3c":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function gamecontrols() {
    // parent div for game controls
    const gamecontrols1 = document.createElement("div");
    gamecontrols1.id = "gamecontrols";
    const blackDiv = document.createElement("div");
    blackDiv.id = "black";
    gamecontrols1.appendChild(blackDiv);
    ...
    gamecontrols1.appendChild(buttons);
    const whiteDiv = document.createElement("div");
    whiteDiv.id = "white";
    gamecontrols1.appendChild(whiteDiv);
    return gamecontrols1;
}
...
function selectGridSize(size) {
    ...
    for(let i = 0; sizeElements && i < sizeElements?.length; i++)sizeElements[i].classList.remove("selected");
    document.getElementById(String(size))?.classList.add("selected");
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"c2uBj"}],"c2uBj":[function(require,module,exports) {
...
},{}],"lrcID":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _row = require("./Row");
var _rowDefault = parcelHelpers.interopDefault(_row);
class Gameboard {
    constructor(handler, nRows){
        this.rows = Array.from({
            length: nRows
        }, (_, i)=>{
            return new (0, _rowDefault.default)(handler, i, nRows);
        });
...
},{"./Row":"65g8X","@parcel/transformer-js/src/esmodule-helpers.js":"c2uBj"}],"65g8X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _cell = require("./Cell");
var _cellDefault = parcelHelpers.interopDefault(_cell);
class Row {
    constructor(handler, id, nCells){
        this.id = id;
        this.cells = Array.from({
            length: nCells
        }, (_, i)=>{
            const cellId = nCells * id + i;
            return new (0, _cellDefault.default)(handler, cellId);
        });
        this.element = document.createElement("div");
...
},{"./Cell":"9m4JQ","@parcel/transformer-js/src/esmodule-helpers.js":"c2uBj"}],"9m4JQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let STATUS;
(function(STATUS1) {
    STATUS1["AVAILABLE"] = "AVAILABLE";
    STATUS1["OCCUPIED"] = "OCCUPIED";
})(STATUS || (STATUS = {}));
class Cell {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"c2uBj"}],"eksWm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Render", ()=>Render);
class Render {
    // takes a html element and renders it to the DOM at the specified id
    static append(source, target) {
    ...
    static removeNode(target) {
        const element = document.getElementById(target);
        if (element) element.remove();
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"c2uBj"}]},["5wrgQ","kuM8f"], "kuM8f", "parcelRequire3791")
